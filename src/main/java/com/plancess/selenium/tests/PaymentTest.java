...
public class PaymentTest extends BaseTest {
	...
	public void makePaymentAfterLoginValidData(Map<String, String> user) {
		...
		List<WebElement> elements = driver
				.findElements(By.xpath(".//*[@id='content']//*[@class='package-cost']//span"));
		String packageText = "";
		...
		executor.verifyTrue(packageText.contains(user.get("price")), "Verify if Package Exists: " + user.get("price"));
	...
	/*
	 * @DataProvider(name = "makePaymentLandingPageValidData") public static
	 * Object[][] signUpDataProviderMandatoryData() { Map<String, String> user =
	 * new HashMap<String, String>();
	 * 
	 * Object[][] dataSet = new Object[1][1]; long timestamp =
	 * System.currentTimeMillis();
	 * 
	 * user.put("password", "P@ssw0rd"); //user.put("confirm_password",
	 * "P@ssw0rd"); user.put("email", "webuser" + timestamp +
	 * "@mailinator.com"); dataSet[0][0] = user; user.put("price", "1599");
	 * user.put("packageName", "JEE Main & Advanced Assessment 2016 Online");
	 * user.put("packageSelected", "1"); user.put("contact", "9167360969");
	 * user.put("bank", "Axis Bank"); user.put("firstname", "test");
	 * user.put("lastname", "user"); return dataSet;
	 * 
	 * }
	 */
